...
import LebronStretch from "../photos/tistasoft-header-logo.png";
  ...
  return (
    <Document>
      <Page style={styles.body}>
        <Text style={[styles.header, { color: "white" }]} fixed>
          REPORT
        </Text>
        ...
        >
          <View style={{ backgroundColor: "#00e600", padding: 20 }}>
            <Text style={{}}>Section #1</Text>
          </View>
          <Text style={{}}>Section #2</Text>
          <Text style={{}}>Section #3</Text>
          <Text style={{}}>Section #4</Text>
        </View>

        {!_.isEmpty(invoiceData) && <InvoiceItemsTable invoice={invoiceData} />}

        <Text style={styles.text}>
          Oh right. I forgot about the battle. Wow, you got that off the
          Internet?. I don't know what you did, Fry, but once again, you screwed
          up! Now all the planets are gonna start cracking wise about our mamas.
          She also liked to shut up! We'll go deliver this crate like
